...
def openai_complete_response(context, query):
    response = open_ai_client.completions.create(
        ...
        prompt=f"Context information is below.\n"
               ...
               f" Answer the query briefly .If the query doesnot match the context information please respond with appropriate message saying he context is not available \n"
               f"Query : {query} \n"
               f"Answer : ",
        max_tokens=100,
        temperature=0
